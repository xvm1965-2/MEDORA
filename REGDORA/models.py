...
class ICTService(models.Model):
    service_id = models.CharField(max_length=3, primary_key=True, verbose_name="Identificativo")
    service_type = models.CharField(max_length=255, verbose_name="Tipo di servizi TIC")
...
class ThirdPartyVendor_B1_01_01(models.Model):
    ...
    def __str__(self):
        return f"{self.lei} - {self.entity_name}"
...
class FinancialEntity_B1_02(models.Model):
    ...
    # B_01.02.0050: Hierarchy of the financial entity within the group (if applicable)
    HIERARCHY_CHOICES = [
        ('1', "l'entità finanziaria è l'impresa madre capogruppo nel consolidamento"),
        ('2', "l'entità finanziaria è l'impresa madre di una parte subconsolidata nel consolidamento"),
        ('3', "l'entità finanziaria è un'impresa figlia nel consolidamento e non è un'impresa madre di una parte subconsolidata"),
        ('4', "l'entità finanziaria non fa parte di un gruppo"),
        ('5', "l'entità finanziaria è un fornitore di servizi al quale l'entità finanziaria (o il fornitore terzo di servizi che agisce per suo conto) esternalizza tutte le sue attività operative"),
    ]
    ...
    # B_01.02.0060: LEI of the direct parent entity
...
class Branch_B1_03(models.Model):
    ...
    # B_01.03.0020: LEI della sede centrale dell'entità finanziaria da cui dipende la succursale
...
class ContractAgreementDetails_B2_02(models.Model):
    ...
    third_party_vendor_code = models.ForeignKey(
    ...
    tic_service_type = models.ForeignKey(
        'ICTService',
        on_delete=models.CASCADE,
    ...
    financial_entity_notice_period = models.PositiveIntegerField(
        ...
        blank=True,
        null=True,
        validators=[validate_notice_period],
    )
    ...
    applicable_law_country = CountryField(
    ...
    service_provision_country = CountryField(
    ...
    # B_02.02.0140: Conservazione dei dati
    ...
    data_at_rest_location = CountryField(
    ...
    data_management_location = CountryField(
...
class IntraGroupContractAgreement_B2_03(models.Model):
    ...
    def __str__(self):
        return f"{self.contract_reference_number} - {self.linked_contract_reference.contract_reference_number}"
...
class ContractSigningEntity_B3_01(models.Model):
    ...
    # B_03.01.0020: LEI dell'entità che firma l'accordo contrattuale
...
class ThirdPartyVendorSigning_B3_02(models.Model):
    ...
    third_party_vendor_code = models.ForeignKey(
        'ThirdPartyVendor_B5_01',  # Link to the ThirdPartyVendor_B5_01 model
        on_delete=models.CASCADE,
...
class FinancialEntityServiceProvider_B3_03(models.Model):
    ...
    # B_03.03.0020: LEI dell'entità finanziaria che fornisce servizi TIC
...
class FinancialEntityServiceUsage_B4_01(models.Model):
    ...
    # B_04.01.0020: LEI dell'entità finanziaria che si avvale del servizio o dei servizi TIC
    financial_entity_lei = models.ForeignKey(
        'FinancialEntity_B1_02',  # Reference to the B_01.02 table
        on_delete=models.CASCADE,
...
class ThirdPartyVendor_B5_01(models.Model):
    ...
    # B_05.01.0070: Fornitore terzo di servizi TIC - tipologia di persona
    VENDOR_TYPE_CHOICES = [
        ('1', "persona giuridica, escluse le persone fisiche che agiscono a titolo professionale"),
    ...
    headquarters_country = CountryField(
        max_length=2,
...
class ServiceEvaluation_B7_01(models.Model):
   ...
   # B_07.01.0040: Tipo di servizi TIC
    ...
    # B_07.01.0050: Sostituibilità del fornitore terzo di servizi TIC
    ...
    # B_07.01.0060: Motivo per cui il fornitore terzo di servizi TIC è considerato non sostituibile o difficilmente sostituibile
    SUBSTITUTABILITY_REASON_CHOICES = [
    ...
    # B_07.01.0080: Esistenza di un piano di uscita
    EXIT_PLAN_CHOICES = [
        ('1', "sì"),
        ('2', "no"),
    ]
    ...
    # B_07.01.0090: Possibilità di reintegrazione del servizio TIC previsto dal contratto
    REINTEGRATION_CHOICES = [
        ('1', "facile"),
        ('2', "difficile"),
        ('3', "molto complessa"),
    ]
    ...
    # B_07.01.0100: Impatto dell'interruzione dei servizi TIC
    IMPACT_CHOICES = [
        ('1', "basso"),
        ('2', "medio"),
        ('3', "alto"),
    ...
    # B_07.01.0110: Sono stati individuati fornitori terzi alternativi di servizi TIC?
    ALTERNATIVE_VENDOR_CHOICES = [
        ('1', "sì"),
        ('2', "no"),
    ...
    def save(self, *args, **kwargs):
        # Try to set the vendor_code from the related third_party_vendor_code
        try:
            third_party_vendor_signing = self.contract_reference_number.thirdpartysigningset.all().first()
            if third_party_vendor_signing:
                # Set the vendor_code from the related third_party_vendor_code field
                self.vendor_code = third_party_vendor_signing.third_party_vendor_code
        except AttributeError:
            # Handle case where no related instance is found
            pass
        
        # Now that vendor_code is set (or potentially remains None), set the code_type
        if self.vendor_code:
            self.code_type = self.vendor_code.code_type  # Set the code_type from the related vendor code
        
        super(ServiceEvaluation_B7_01, self).save(*args, **kwargs)
